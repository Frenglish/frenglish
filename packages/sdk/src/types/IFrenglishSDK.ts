import { Configuration, PartialConfiguration, FileContentWithLanguage, RequestTranslationResponse, TranslationResponse, File, TranslationStatus } from '@frenglish/utils';

export interface IFrenglishSDK {
    registerWebhook(webhookUrl: string): Promise<void>;
    translate(content: string[], isFullTranslation?: boolean, filenames?: string[], partialConfig?: PartialConfiguration): Promise<RequestTranslationResponse | undefined>;
